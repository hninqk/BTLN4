        ...
        CompletableFuture.supplyAsync(() -> AppFacade.getInstance().getPublicAuctions())
            .thenAccept(auctions -> {
                for (com.auction.core.model.Auction a : auctions) {
                    if (a.getStatus() != com.auction.core.model.AuctionStatus.RUNNING) continue;
                    ...
                    AppFacade.getInstance().findAuctionById(a.getId()).ifPresent(fullAuction -> {
                        ...
                        for (com.auction.core.model.BidTransaction bt : fullAuction.getBidHistory()) {
                        ...
                        if (hasBid) {
                            biddedAuctionIds.add(fullAuction.getId());
